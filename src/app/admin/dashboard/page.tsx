      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            ...
            <h2 className="text-xl font-black text-gray-900 mb-2">Diseño y Catálogo</h2>
            <p className="text-gray-500 font-medium text-sm flex-1">Personaliza tus colores, logotipo y decide cómo quieres vender.</p>
          </div>
