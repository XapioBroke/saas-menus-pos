      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          >
            ...
            <p className="text-gray-500 font-medium text-sm flex-1">Caja registradora. Otorga puntos y escanea QRs de clientes.</p>
          </div>
          ...
          >
            ...
            <p className="text-gray-500 font-medium text-sm flex-1">Catálogo, colores, logotipo y cerebro de la Inteligencia Artificial.</p>
          </div>

          {/* Tarjeta 3: Recompensas (NUEVA) */}
          <div 
          ...
          >
            ...
            <p className="text-gray-500 font-medium text-sm flex-1">Configura el valor de tus puntos y las recompensas por canje.</p>
          </div>

          {/* Tarjeta 4: Portal Público y QR */}
          <div className="bg-white p-8 rounded-3xl shadow-xl border border-gray-100 flex flex-col items-center text-center">
            ...
            {publicUrl ? (
              <div className="w-full mt-auto space-y-3">
                ...
                <button onClick={() => window.open(publicUrl, "_blank")} className="w-full py-2 bg-black text-white text-sm font-bold rounded-xl hover:bg-gray-800">Ver en Vivo</button>
