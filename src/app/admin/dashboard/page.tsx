    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
          ...
          {/* Tarjeta 4: Suscripción SaaS (El Botón Faltante) */}
          <div 
          ...
          >
            ...
            <p className="text-gray-400 font-medium text-sm flex-1 z-10">Activa tu plan y gestiona tus cobros recurrentes.</p>
          </div>

          {/* Tarjeta 5: Portal Público y QR */}
          <div className="bg-white p-8 rounded-3xl shadow-xl border border-gray-100 flex flex-col items-center text-center">
            ...
            {publicUrl ? (
              <div className="w-full mt-auto space-y-3">
                ...
                {/* Tarjeta 6: Pantalla de Comandas (KDS) */}
          <div 
          ...
          >
            ...
            <p className="text-gray-500 font-medium text-sm flex-1">Gestión interactiva de pedidos en tiempo real para cocina y caja.</p>
          </div>
